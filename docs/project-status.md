...
| Next      | Automatic financial-data ingestion | Customers can reduce manual entry through an agreed bank, import, or other ingestion source                                                             | Not implemented               | Research source, consent, reconciliation, failure handling, and market fit                                                                                                                                                                                                           |

The next product discovery milestone is therefore **Automatic financial-data
ingestion**. Before implementation, validate the source and market need because
bank connectivity, file import, and other ingestion methods have materially
different consent, reconciliation, and failure-handling requirements.
