...
| Next      | Account and data self-service      | Customers can manage profile/consent, export data, and delete their account                                                                             | Not implemented               | Define policy, API contracts, support path, and mobile UX                                                                                                                                                                                            |
...
The next immediate product milestone is therefore **Account and data
self-service**, not another test suite. Stability-model and alert-copy user
validation should run alongside product discovery before the score or alerts
are treated as financial guidance.
