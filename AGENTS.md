...
- **Node.js 24.15+ (24.x)** (required by NestJS 12 tooling and Jest ESM support; TypeScript 6 remains installed only as a compiler-API compatibility layer for supporting tools)
