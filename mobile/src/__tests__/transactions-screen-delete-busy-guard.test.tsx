...
describe('transactions screen delete busy guard', () => {
  beforeEach(() => {
    queryClient.clear();
    jest.clearAllMocks();
  ...
  it('disables every delete action while one deletion is in flight', async () => {
    ...
    expect(
      screen.getByRole('button', { name: 'Delete Salary slice transaction' }),
    ).toBeDisabled();
