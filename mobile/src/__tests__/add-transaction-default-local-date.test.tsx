...
describe('add transaction default local date', () => {
  beforeEach(() => {
    queryClient.clear();
    jest.clearAllMocks();
    ...
    mockCreateTransaction.mockResolvedValue({
      ...
      amountKobo: 500_000,
      direction: 'in',
      occurredAt: '2011-11-11T12:00:00.000Z',
      note: 'manual entry',
      createdAt: '2011-11-11T12:00:00.000Z',
    });
  });

  it('seeds the date field from the device-local day and submits that ISO timestamp', async () => {
    await renderScreen();
