...
describe('AuthService verify OTP consume write failure', () => {
  ...
  it('does not retire leftovers, record success, or mint a session when consume fails', async () => {
    const otp = '123456';
    ...
    prisma.otpCode.updateMany.mockRejectedValue(
      new Error('consume unavailable'),
    );
