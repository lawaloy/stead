...
describe('AuthService leftover OTP sweep failure after lock', () => {
  ...
  it('does not record lock telemetry when leftover retirement fails after max attempts', async () => {
    ...
    prisma.otpCode.updateMany.mockRejectedValue(new Error('sweep failed'));
